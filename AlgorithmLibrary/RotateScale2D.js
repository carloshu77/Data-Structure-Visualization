...
RotateScale2D.prototype.addControls =  function()
{
	...
	var transformButton = addControlToAlgorithmBar("Button", "变换");
	...
	var radioButtonList = addRadioButtonGroupToAlgorithmBar(["+y 向上", 
															 "+y 向下", 
															 ], 
															"yAxisDirection");
	...
	var radioButtonList = addRadioButtonGroupToAlgorithmBar(["旋转, 然后缩放", 
															 "缩放, 然后旋转", 
															 ], 
															"RotateFirst");

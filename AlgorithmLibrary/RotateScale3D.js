...
RotateScale3D.prototype.addControls =  function()
{
	...
	var scaleButton = addControlToAlgorithmBar("Button", "缩放");
	...
	var changeShapeButton = addControlToAlgorithmBar("Button", "改变形状");
